...
public class RobotDriveModified implements MotorSafety
{
	...
	{
		// kMiddleLeft(2), kMiddleRight(3) were added by Laura A, for 6 motor
	 	kFrontLeft(0), kFrontRight(1), kMiddleLeft(2), kMiddleRight(3), kRearLeft(4), kRearRight(5);
	...
	protected static final int kMaxNumberOfMotors = 6; //Added by Laura Albrant, changed from 4 to 6
	protected double m_sensitivity;
	protected double m_maxOutput;
	protected SpeedController m_frontLeftMotor;
	protected SpeedController m_frontRightMotor;
	//Added by Laura A, for 6 motor
	...
	protected static boolean kMecanumPolar_Reported = false;
	   ...
	   */
	  public RobotDriveModified(final int leftMotorChannel, final int rightMotorChannel) 
	  {
	   ...
	   */
	  public RobotDriveModified(final int frontLeftMotor, final int rearLeftMotor, 
	  ...
	  //Added by Laura Albrant, for 6 motor setup
	  /**
	   * Constructor for RobotDrive with 6 motors specified with channel numbers. Set up parameters for
	   * a six wheel drive system with 6 motors where all six motor pwm channels are specified in the call. This
	   * call assumes Talons for controlling the motors.
	   *
	   * @param frontLeftMotor    Front left motor channel number
	   * @param rearLeftMotor     Rear Left motor channel number
	   * @param middleLeftMotor   Middle Left motor channel number
	   * @param frontRightMotor   Front Right motor channel number
	   * @param middleRightMotor  Middle Right motor channel number
	   * @param rearRightMotor    Rear Right motor channel number
	   */
	  public RobotDriveModified(final int frontLeftMotor, final int middleLeftMotor, final int rearLeftMotor, 
	   ...
	   */
	  public RobotDriveModified(SpeedController leftMotor, SpeedController rightMotor) 
	  {
	   ...
	   */
	  public RobotDriveModified(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
	   ...
	   * @param rearRightMotor  The back right SpeedController object used to drive the robot.
	   */
	  public RobotDriveModified(SpeedController frontLeftMotor, SpeedController middleLeftMotor, SpeedController rearLeftMotor, 
	  ...
	  /**
	   * Arcade drive implements single stick driving. Given two joystick instances and two axis,
	   * compute the values to send to either two or four (or six thanks to "Added by Laura") motors.
	   *
	   * @param moveStick   The Joystick object that represents the forward/backward direction
	   * @param moveAxis    The axis on the moveStick object to use for forwards/backwards (typically
	   *                    Y_AXIS)
	  ...
	  //Added by Laura Albrant... potentially
	  //Come back to this
	  /**
